    ...
    <body>
        ...
        <main>
            ...
            <div class="voice_list_3">
                <div class="clearfix">
                    <p>接客、施術、会話すべて期待以上で大変満足しました。施術後はカラダが軽くなっただけではなく心もすっかり癒されました。セラピストさんの確かな技術とお人柄のおかげだとつくづく感じました。是非またリピートしたいです。</p>
                    <p>H様＜50代男性＞★★★★★</p>
                </div>
                <img src="img/fukidashi_hidari.jpg" alt="料金表">
            </div>
            <div class="question">
                ...
                <div class="question_box">
                    <div>
                        <p>Q.どんなコース内容ですか？</p>
                        <p>A.東京リフレのセラピストは様々なマッサージスキルを保有しており、お客様のお身体の状態やご要望に合わせて、施術させていただきます。</p>
                    </div>
                </div>
                <div class="question_box">
                    <div>
                        <p>Q.２名での利用はできますか？</p>
                        <p>A.ご利用可能です。ご夫婦様、お友達同士などのご利用の際は、セラピストを２名出張致します。</p>
                    </div>
                </div>
                <div class="question_box">
                    <div>
                        <p>Q.宿泊しているホテルで利用できるかわからないのですが…</p>
                        <p>A.出張可能なホテルかどうかは当店でお調べします。お気軽にお問い合わせください。</p>
                    </div>
                </div>
                <div class="question_box">
                    <div>
                        <p>Q.何か準備しておくことはありますか？</p>
                        <p>A.いいえ、何もございません。タオルなどの道具はすべてお持ちします。事前にシャワーを浴びられることをオススメしております。</p>
                    </div>
                </div>
                <div class="question_box">
                    <div>
                        <p>Q.気持ちよくなって寝てしまった場合は？</p>
                        <p>A.お支払いはカウンセリングの際にいただきますので、おやすみになられてしまった場合は、そのままごゆっくりお休みください。</p>
                    </div>
                </div>
                <div class="question_box">
                    <div>
                        <p>Q.領収書は発行できますか？</p>
                        <p>A.はい、発行可能です。ご予約時、もしくは担当セラピストにお申し付けください。</p>
                    </div>
                </div>
