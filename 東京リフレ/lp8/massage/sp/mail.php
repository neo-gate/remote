...
$site_top = "http://www.tokyo-refle.com/lp8/massage/sp/";
...
$require = array('ご利用開始時間','ご利用コース','お名前','電話番号','Email','ご訪問先住所');
...
ご希望頂いた条件で予約状況を確認し、メールにてご連絡させていただきます。
そのメールに返信いただいてご予約完了となります。
メールが送れなかった場合やご予約時間間際場合はお電話にてご連絡する場合もございますのでよろしくお願いいたします。
...
<meta name="viewport" content="width=640px, user-scalable=no, target-densitydpi=device-dpi">
<title>完了画面</title>
<!-- Global site tag (gtag.js) - Google AdWords: 815055253 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-815055253"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-815055253');
</script>
<!-- Event snippet for フォームCV conversion page -->
<script>
  gtag('event', 'conversion', {
      'send_to': 'AW-815055253/myg0CLPQgH4QlYPThAM',
      'transaction_id': ''
  });
</script>
</head>
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none">東京リフレ</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
