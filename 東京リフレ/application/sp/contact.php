...
<div id="formWrap">
  <form method="post" action="check.php">
    <div class="formTable">
			<div class="box_name">
				<p class="txt1">お名前<span class="hissu">必須</span></p>
			...
			<div class="box_date">
				<p class="txt">面接希望日時<span class="nimni">任意</span></p>
			</div>
			<div style="float:left;">
			<div class="box">
				<p><span class="hope_day">第1希望</span><br>
          <select class="form-control" id="exampleFormControlSelect1" name="date1">
          ...
          <select class="form-control" id="exampleFormControlSelect1" name="date2">
            <option>選択してください</option>
            <option><?php echo date("Y/m/d",strtotime("0 day"));?></option>
            <option><?php echo date("Y/m/d",strtotime("1 day"));?></option>
            <option><?php echo date("Y/m/d",strtotime("2 day"));?></option>
          ...
          <select class="form-control" id="exampleFormControlSelect1" name="date3">
            <option>選択してください</option>
            <option><?php echo date("Y/m/d",strtotime("0 day"));?></option>
            <option><?php echo date("Y/m/d",strtotime("1 day"));?></option>
            <option><?php echo date("Y/m/d",strtotime("2 day"));?></option>
