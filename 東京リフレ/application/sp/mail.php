...
$site_top = "http://www.tokyo-refle.com/recruit.php";
...
$thanksPage = "http://www.tokyo-refle.com/application/sp/thanks.php";
...
$refrom_name = "【東京リフレ】採用窓口";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "ご応募ありがとうございます";
...
<?php }else{ ?>
<h3>確認画面</h3>
<p style="font-size:24px; line-height:130%;"align="center">以下の内容で間違いがなければ、<br>「送信する」ボタンを押してください。</p>
...
<input type="button" value="前画面に戻る" id="return_btn" onClick="history.back()"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
