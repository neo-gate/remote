...
//$('#ichiretsu_title_new').css("z-index", "9999");

$('#calendar_display_right_content').css("padding-top", "51px");
$('#calendar_display_right_content').css("padding-left", "70px");

//$('#calendar_display_left').css("position", "absolute");
//$('#calendar_display_left').css("top", (p_top)*-1);
//$('#calendar_display_left').css("left", "0");

$('#therapist_name_list').css("position", "absolute");
$('#therapist_name_list').css("top", ((p_top)*-1)+51);
$('#therapist_name_list').css("left", "0");

$('#gyou_day').css("position", "absolute");
$('#gyou_day').css("top", "0");
$('#gyou_day').css("left", ((p_left)*-1)+70);

//$('#gyou_day').css("z-index", "-1");
//$('#calendar_display_left').css("z-index", "-1");
