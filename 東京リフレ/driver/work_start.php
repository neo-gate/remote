...
if( isset($_POST["send"]) == true ){
	...
	*/
	...
	if( $error == "" ){
		...
		//データの記録、更新
		update_work_meter_start($meter,$attendance_staff_new_id);
		...
		if( $upload_ok_flg == true ){
			...
			// メールのタイトル
			$mailSubject = sprintf('ドライバー開始時メーター　%s月%s日　%s',$month,$day,$staff_name);
			...
			*/
			...
			$returnMail  = 'murase@skipboat.com';
...
$smarty->assign( 'content_tpl', 'sp/work_start.tpl' );
