...
{{$params.message_board_data[cnt].day_disp}}
</div>
<div style="font-size:12px;">
<a href="message_board.php?area={{$params.area}}&ch={{$params.ch}}&id={{$params.staff_id}}#page_{{$params.message_board_data[cnt].id}}">{{$params.message_board_data[cnt].title}}</a>
</div>
</div>
{{/section}}
		</div>
...
<div style="padding:0px 0px 100px 0px;">
	...
	<div class="title_bar2">
		...
		{{else}}
			<a href="index.php?area={{$params.area}}&id={{$params.staff_id}}&year={{$params.today_year}}&month={{$params.today_month}}&ch={{$params.ch}}" style="font-size:10px;">
		...
		{{else}}
			<a href="index.php?area={{$params.area}}&id={{$params.staff_id}}&year={{$params.next_year}}&month={{$params.next_month}}&ch={{$params.ch}}" style="font-size:10px;">
		...
		{{else}}
			<a href="index.php?area={{$params.area}}&id={{$params.staff_id}}&year={{$params.year_3}}&month={{$params.month_3}}&ch={{$params.ch}}" style="font-size:10px;">
				{{$params.month_3}}月シフト
			</a>
		{{/if}}
